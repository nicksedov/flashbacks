export const translationsRu = {
  ...
  "adminPanel.noAccount": "Нет учётной записи?",
  "adminPanel.haveAccount": "Уже есть учётная запись?",
  "adminPanel.switchToRegister": "Создать учётную запись",
  "adminPanel.switchToLogin": "Войти",
  ...
  "llm_ocr.vlSameAsChat": "Используется тот же провайдер, что и для чата",
