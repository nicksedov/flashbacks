export const translationsRu = {
  ...
  "trashTab.deleteConfirm": "Удалить навсегда \"{fileName}\"?",
  "trashTab.deleting": "Удаление...",
  ...
  "gallery.subModes.allImages": "Все изображения",
  ...
  "gallery.sortNone": "Без сортировки",
  ...
  // Регистрация
  "adminPanel.registerTab": "Создать учётную запись",
  "adminPanel.registerTitle": "Создание учётной записи",
  "adminPanel.registerDesc": "Зарегистрируйтесь, чтобы получить доступ к приложению",
  "adminPanel.registerButton": "Зарегистрироваться",
  ...
  "adminPanel.registrationRequestsEmpty": "Нет ожидающих заявок",
  "adminPanel.approve": "Одобрить",
  "adminPanel.reject": "Отклонить",
  "adminPanel.approveSuccess": "Учётная запись одобрена",
  "adminPanel.rejectSuccess": "Учётная запись отклонена",
  "adminPanel.rejectTitle": "Отклонение учётной записи",
  "adminPanel.rejectDesc": "Отклонить регистрацию для {displayName}",
  "adminPanel.rejectionReason": "Причина отклонения",
  "adminPanel.rejectionReasonPlaceholder": "Введите причину",
  "adminPanel.rejectionReasonRequired": "Укажите причину отклонения",
  "adminPanel.statusPending": "Ожидает",
  "adminPanel.statusRejected": "Отклонена",
  ...
  "llm_ocr.chatSettings": "Настройки чат LLM",
  "llm_ocr.chatSettingsDescription": "Настройка ИИ-ассистента: диалог, вызов инструментов, анализ",
  "llm_ocr.vlSettings": "Настройки VL LLM",
  "llm_ocr.vlSettingsDescription": "Настройка ИИ: описание, теги, визуальные ответы",
  "llm_ocr.ocrSettings": "Настройки OCR LLM",
  "llm_ocr.ocrSettingsDescription": "Настройка ИИ для распознавания текста на изображениях",
  ...
  "llm_providers.usageShortOCR": "OCR",
  ...
  "llm_providers.deleteTitle": "Удалить провайдера",
  ...
  "moveFiles.createFolder": "Создать новую папку",
  "moveFiles.newFolderPlaceholder": "Имя папки",
  "moveFiles.createButton": "Создать",
  "moveFiles.selectFolderFirst": "Сначала выберите папку в дереве",
  ...
  "about.description": "Информация о приложении, его лицензии и используемых сторонних компонентах.",
  "about.section.about": "О программе",
  "about.section.license": "Лицензия ПО",
  "about.section.thirdParty": "Сторонние компоненты",
  "about.aboutTitle": "О Flashbacks",
  "about.aboutText": "Приложение для самостоятельного хостинга и интеллектуального управления персональной фотоколлекцией.",
  "about.feature.deduplication": "Поиск дубликатов и похожих изображений",
  "about.feature.metadata": "Извлечение EXIF-метаданных и геолокации",
  "about.feature.ocr": "Распознавание текста на изображениях (OCR)",
  "about.feature.gallery": "Организация фотографий в галерее, календаре и на карте",
  "about.feature.smartSearch": "Умный поиск по контенту",
  "about.feature.enhancement": "Улучшение качества изображений",
  "about.author": "Автор",
  "about.copyright": "© 2026 Николай Седов. Все права защищены.",
  "about.license.description": "Программное обеспечение распространяется под лицензией MIT.",
  "about.license.permission": "Настоящим разрешается любому лицу бесплатно получить копию данного программного обеспечения и связанных с ним документов и использовать программное обеспечение без ограничений, включая право использовать, копировать, изменять, объединять, публиковать, распространять, сублицензировать и продавать копии программного обеспечения, при условии, что уведомление об авторском праве и данное уведомление о разрешении будут включены во все копии или значимые части программного обеспечения.",
  "about.license.copyright": "Программное обеспечение предоставляется «как есть», без каких-либо гарантий.",
  "about.thirdParty.description": "В приложении используются следующие компоненты с открытым исходным кодом:",
 } as const
